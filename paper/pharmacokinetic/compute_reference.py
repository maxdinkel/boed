...
from .probabilistic_model import designs, log_likelihood_jax, noise_model, output_dir, forward_model, draw_samples
...
if __name__ == '__main__':
    ...
    for estimator, leave_out in estimators.items():
        ...
        samples = draw_samples(1_000_000, rng)
        for i, xi in enumerate(designs):
            outputs = forward_model(samples, xi)
